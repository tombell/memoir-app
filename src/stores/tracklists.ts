...
const $routeParams = computed($router, (page) => ({
  tracklistsPage: page?.route === "tracklistsIndex" ? page.search.page || "1" : undefined,
  currentTracklistId:
    page?.route === "tracklistsShow" || page?.route === "tracklistsEdit"
      ? page.params.id
      : undefined,
  tracklistsByTrackId: page?.route === "tracklistsByTrack" ? page.params.id : undefined,
  tracklistsByTrackPage: page?.route === "tracklistsByTrack" ? page.search.page || "1" : undefined,
  currentPath: page?.path ?? "",
}));

export const $tracklistsPage = computed($routeParams, (params) => params.tracklistsPage);

export const $currentTracklistId = computed($routeParams, (params) => params.currentTracklistId);

export const $tracklistsByTrackId = computed($routeParams, (params) => params.tracklistsByTrackId);
...
export const $currentPath = computed($routeParams, (params) => params.currentPath);
